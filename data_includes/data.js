...
var defaults = [
    ...
    "Boxes", {
        as: ["Satisfies the rule", "Doesn't satisfy the rule"],
        hasCorrect: false,
...
var items = [
    ...
    ["real", "Boxes", {html: {include: "item127.html"}}],
    ["real", "Boxes", {html: {include: "item128.html"}}],
    ["real", "Boxes", {html: {include: "item129.html"}}],
    ["real", "Boxes", {html: {include: "item130.html"}}],
    ["real", "Boxes", {html: {include: "item131.html"}}],
    ["real", "Boxes", {html: {include: "item132.html"}}],
    ["real", "Boxes", {html: {include: "item133.html"}}],
    ["real", "Boxes", {html: {include: "item134.html"}}],
    ["real", "Boxes", {html: {include: "item135.html"}}],
    ["real", "Boxes", {html: {include: "item136.html"}}],
    ["real", "Boxes", {html: {include: "item137.html"}}],
    ["real", "Boxes", {html: {include: "item138.html"}}],
    ["real", "Boxes", {html: {include: "item139.html"}}],
    ["real", "Boxes", {html: {include: "item140.html"}}],
    ["real", "Boxes", {html: {include: "item141.html"}}],
    ["real", "Boxes", {html: {include: "item142.html"}}],
    ["real", "Boxes", {html: {include: "item143.html"}}],
    ["real", "Boxes", {html: {include: "item144.html"}}],
